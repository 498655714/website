    ...
    <div class="layui-form layui-form-pane" lay-filter="layuiadmin-btn-admin" id="layuiadmin-btn-admin" style="padding: 20px 30px 0 0;">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="title"  lay-verify="required" placeholder="不多于150个字符" value="{{ old('title') }}" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">简略标题  <small style="color: red">*</small></label>
            <div class="layui-input-block">
                <input type="text" name="short_title" lay-verify="required" placeholder="不多于50个字符" value="{{ old('short_title') }}" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="checkbox" name="flag[]" value="{{ $key }}" title="{{ $flag }}[{{ $key }}]" @if(old('flags')){{ in_array($key,old('flags')) ? 'checked' : ''}}@endif   class="layui-input">
                @endforeach
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="tag" lay-verify="" placeholder="英文 ',' 号分开，单个标签小于12字节" value="{{ old('tag') }}" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">缩略图</label>
            <div class="layui-input-inline">
                <input name="thumb" lay-verify="" id="thumbSrc" placeholder="图片地址" value="{{ old('thumb') }}" class="layui-input">
            </div>
            ...
            <div class="layui-input-inline">
                <input name="writer" lay-verify="required"   value="{{ old('writer') }}"  placeholder=""  class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="keywords" lay-verify="required" placeholder="英文 ',' 号分开" value="{{ old('keywords') }}"autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">内容摘要 <small style="color: red">*</small> </label>
            <div class="layui-input-block">
                <textarea name="description" placeholder="请输入内容,内容要少于255个字符" class="layui-textarea">{{ old('description') }}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <script>
                    var myckeditor = CKEDITOR.replace( 'ckeditor', {
                    ...
                    myckeditor.on("change",  function(evt){
                        document.getElementById("ckeditor").innerHTML = this.getData();
                    });
                </script>
            </div>
        </div>
        <div class="layui-form-item layui-hide">
            ...
            <input type="button" lay-submit lay-filter="articles_add" id="articles_add" value="确认">
        </div>
    </div>
